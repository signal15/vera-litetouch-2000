...
# Setup #
  1. Install the plugin, restart LUUP
  1. Go into the settings tab for the plugin, select your serial interface, restart LUUP
  1. Go into the advanced tab and set the **RelayLoads** and **DimmerLoads** variables.  Enter them as a comma separated list with no spaces, for example: "07-1,07-2,07-3,07-4,07-5,07-6,08-1,08-2,08-3,08-4,08-5,08-6,09-1,09-2,10-1,10-2,10-3,10-4,10-5,10-6"
  1. Restart LUUP
